...
//Formats numbers to ensure at least 2 decimal places Example: 5.1 → 5.10 If no decimal portion:Returns just the integer part Example: 7 → "7"
...
//for future use of shipping dates
